...
var constraints = {audio:true,video:{width:{min:640,ideal:640,max:640 },height:{ min:480,ideal:480,max:480}, facingMode: { exact: "environment" }, framerate:60}};
...
</script><svelte:head><title>Record</title><meta name="viewport" content="width=device-width, initial-scale=1.0,  maximum-scale=1"> 
<meta name="title" content="Record">
...
<div>
	...
	<div>
		<video id="live" controls autoplay playsinline><track kind="captions"></video> <video id="playback" controls autoplay><track kind="captions"></video><br>
		<div id="controls">
			...
			<button id="vlog" onclick="window.location.href='/vlog'">Vlog</button>
		</div>
	</div>
