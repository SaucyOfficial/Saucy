...
document.body.appendChild(Object.assign(document.createElement('script'), {
  ...
  src: 'https://unpkg.com/x-frame-bypass@1.0.2/x-frame-bypass.js',
  onload: () => this.onScriptLoaded()
}));
</script><svelte:head><title>Fortnite Cosmetics</title><meta name="viewport" content="width=device-width, initial-scale=1.0,  maximum-scale=1"> 
<meta name="title" content="Fortnite Cosmetics">
<meta name="description" content="Fortnite cosmetics for Fortnite Battle Royale, Fortnite Creative, Fortnite Party Royale, and Fortnite Save the World.">
<meta name="keywords" content="fortnite cosmetics, cosmetics, fortnite">
...
<iframe is="x-frame-bypass" id="embeds" title="saucy"  src="https://fnbr.co/list" frameborder="0"></iframe>
